...
cyclic_buffer
	...
	Effectivness and the "work under pressure" it's cyclic because when it reaches
	The end of the buffer it goes back to the begining of it so we can say its endless.
	It uses an array of chars and two pointers (read,write) where both initially points
	At the begining of the array and when a string is being written to it the write
...
(makes the read,write pointers point to the begining of the buffer)
******************************************************************************/
 ...
 buffer_write
 Description:
 	 The function recevies a cyclic buffer to write to and a char to be written
 ...
 ******************************************************************************/
 ...
 buffer_write
 Description:
 	 The function recevies a cyclic buffer to read from, returns the current char
 	 Read pointer pointing at and advances it by 1.if reached the end of the buffer
 	 It takes it back to the begining
 ******************************************************************************/
